public class Dungeon{
    ...
    Charactor m = new Monster("",0,0,0,0);

    public void GoblinD() {
        System.out.println("고블린 소굴에 입장하였습니다.");
        m = new Monster("고블린", 10, 1, 0, 9);
        War.getInstance().FirstChoose();
        m = new Monster("고블린", 10, 1, 0, 9);
        War.getInstance().FirstChoose();
        m = new Monster("홉 고블린 마크노크", 14, 2, 0, 9);
        War.getInstance().FirstChoose();
        if (m.getHp()==0) {
    ...
    public void OrkD() {
        ...
        m = new Monster("오크", 12, 3, 0, 9);
        War.getInstance().FirstChoose();
        m = new Monster("오크", 12, 3, 0, 9);
        War.getInstance().FirstChoose();
        m = new Monster("오크 족장 라흐라프", 26, 4, 0, 9);
        War.getInstance().FirstChoose();
        if (m.getHp()==0) {
    ...
    public void ElfD() {
        ...
        m = new Monster("나이트 엘프 정찰병", 12, 5, 0, 9);
        War.getInstance().FirstChoose();
        m = new Monster("나이트 엘프 정찰병", 12, 5, 0, 9);
        War.getInstance().FirstChoose();
        m = new Monster("나이트 엘프 정예병 퀴르귀스", 15, 6, 0, 9);
        War.getInstance().FirstChoose();
        m = new Monster("나이트 엘프 장로 반스톰프", 20, 7, 0, 9);
        War.getInstance().FirstChoose();
        if (m.getHp()==0) {
    ...
    public void LichD() {
        ...
        m = new Monster("리치왕 아서스 메놀드", 91, 9, 1, 11);
